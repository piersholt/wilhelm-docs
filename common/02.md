...
1. Announcing the presence of a module on the bus.
...
Normally one byte. Some modules append variant-specific data.

Radio `0x68` announcements may include a second byte. The two least significant bits carry a radio-specific state/variant value.
...
### Variant `0b1111_1000`
    ...
    BMBT_4_3        = 0b0000_0  # Tape
    BMBT_16_9       = 0b0011_0  # Tape
    BMBT_16_9_CD    = 0b0111_0  # CD
    BMBT_16_9_MD    = 0b1011_0  # Minidisc
...
An announcement also allows the new module to establish it's state. and any applicable modules will respond as necessary.
...
| Module | Variant | Signature | Frame               |
|:-------|:--------|:----------|:--------------------|
| BMBT   | 4x3 Tape     | `0x00`    | `F0 04 BF 02 01 48` |
| BMBT   | 16x9 Tape    | `0x30`    | `F0 04 BF 02 31 78` |
| BMBT   | 16x9 CD      | `0x70`    | `F0 04 BF 02 71 38` |
| BMBT   | 16x9 Minidisc| `0xb0`    | `F0 04 BF 02 B1 F8` |

#### CID `0x46`

| Module | Variant         | Signature | Frame               |
|:-------|:----------------|:----------|:--------------------|
| CID    | Flip-up display | `0x30`    | `46 04 FF 02 31 8E` |
...
| LCM    | `0xd0`  | LCM (E39)    | `0x00`    | `D0 04 BF 02 01 68` |
