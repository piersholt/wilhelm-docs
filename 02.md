...
### Variant `0b1111_1000`
    ...
    BMBT_16_9_MD    = 0b1011_0  # Minidisc (never produced)
...
An announcement also allows the new module to establish it's state. and any applicable modules will respond as necessary. The response will depend on the announcing module, but will at minimum, include ignition state `0x11` from the cluster.
