...
4 byte bit field. Fixed length.
    ...
    CLUSTER_TYPE          = 0b1111_0000
    
    # Byte 2
    FORMAT_TIME           = 0b0000_0001
    UNIT_TEMPERATURE      = 0b0000_0010
    OBC_RESUME_AT_KLR     = 0b0000_0100
    OBC_SPEED_CORRECTION  = 0b0000_1000
    UNIT_AVG_SPEED        = 0b0001_0000
    UNIT_LIMIT            = 0b0010_0000
    UNIT_DISTANCE         = 0b0100_0000
    FORMAT_ARRIVAL        = 0b1000_0000
    
    # Byte 3
    UNIT_CONSUMP_1        = 0b0000_0011
    UNIT_CONSUMP_2        = 0b0000_1100
    UNIT_RANGE            = 0b0001_0000
    FORMAT_AUX_TIMER_1    = 0b0010_0000
    FORMAT_AUX_TIMER_2    = 0b0100_0000
    MEMO_TYPE             = 0b1000_0000

    # Byte 4
    AUX_HEATING           = 0b0000_0001
    AUX_VENTILATION       = 0b0000_0010
    MOTOR_TYPE            = 0b0000_1000
    RCC_TIME              = 0b0001_0000  
    EQUIPPED_AUX_CONTROL  = 0b0100_0000
...
### Cluster Type `0b1111_0000 << 24`
    ...
    CLUSTER_LOW     = 0b0011_0000   # E39/E53 standard
    
    CLUSTER_E46_A   = 0b0100_0000   # E46 Variant A?
    CLUSTER_E46_B   = 0b0110_0000   # E46 Variant B?
    CLUSTER_E46_C   = 0b1111_0000   # E46 Variant C?
    
    CLUSTER_E85     = 0b1010_0000   # E85 Z4, E83 X3

This may affect the behaviour of radio, and telephone, neither of which is coded for a specific type of cluster, but will make use of high cluster (IKE/IKI) character display if available.
...
If enabled, LCM is responsible for memo, which is generated via Check Control. The LCM does not read this `MEMO_TYPE` bit from command `0x15`; the corresponding behaviour is selected through LCM coding.
