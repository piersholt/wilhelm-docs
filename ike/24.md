...
Normal cluster traffic commonly uses `0x00`. Bits 1 and 7 are display-control flags. Bit 7 is used with property `0x24`; the visible effect of both flags is not yet identified.
