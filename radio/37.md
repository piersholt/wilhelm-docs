...
Signed magnitude. See [`0x36`](36.md) for reference.
...
**TODO: technically the wrong image. Should not have hover state**

![C23 CDC Select](37/bm53_eq.png)

Value |Value |Value |Text   |State
:-----|:-----|:-----|:------|:---
`FUNCTION_TONE & ROW_D`|`0b1111_0000 & 0b0011_0000`|`0xf0`|Balance|Highlight
`FUNCTION_TONE & ROW_C`|`0b1110_0000 & 0b0010_0000`|`0xe0`|Fader  |Highlight
`FUNCTION_TONE & ROW_B`|`0b1101_0000 & 0b0001_0000`|`0xd0`|Treble |Highlight
