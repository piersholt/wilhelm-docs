...
Updates the tone menu values as the properties are adjusted.

![Tone](36/treble.jpg)

### Related Commands

- `0x32` [DSP Volume](../dsp/32.md)
- `0x34` [DSP Equalizer Button](../dsp/34.md)
- `0x35` [DSP Status](../dsp/35.md)
- `0x36` [DSP Control](../dsp/36.md)
...
The parameters in this section describe the Radio → GT Tone-display form.
