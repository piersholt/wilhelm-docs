...
NG radio UI / station-list state.

This bit is independent from the priority and hide flags. The corresponding GT → Radio `0x45` bit enables or disables the NG station list.
