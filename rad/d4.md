...
The same station-list format is also used by the Sirius/SDRS module (`0x73`).
...
Type of the message.
    ...
    STATION_LIST      = 0x03  # Message from Radio/SDRS when focusing, changing station or station update.
...
On the BM54, the contents are exclusively used in FMD mode.
