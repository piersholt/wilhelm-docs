...
CCM `0x30` → Global Broadcast `0xbf`
...
Fixed length. One-byte bitfield for LCM.
...
![Check Control Overview](51/oil_level_yellow_stop.jpg)
	...
	30 04 BF 51 40 9A   # Turn on Engine Oil Level indicator


#### Preheating

`0x08` is the diesel preheating indicator request.

#### Catalytic Converter Overheating

`0x20` is the catalytic-converter overheat warning used by Japan-market vehicles. 
