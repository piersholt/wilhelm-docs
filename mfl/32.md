...
The R/T mode has no effect on volume. Whether radio or telephone is the recipient of volume commands is based on [telephone status](../tel/2c.md); specifically the "active", and "handsfree" bits being set (as per an active call on speakerphone).
