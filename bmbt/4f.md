...
The input source switching in handled by the video module, but each source has own brightness settings which are recalled.
...
The GT will turn the monitor on at ignition position 1 (KL-R), and off at ignition position 0.
