...
Reports the current telephone state.
...
Fixed length bitfield of one byte.
    ...
    PHONE_MENU          = 0b0000_0010
    ESTABLISHING_CALL   = 0b0000_0100
    SCREEN_LOCKED       = 0b0000_1000
    POWER               = 0b0001_0000
    ON_CALL             = 0b0010_0000
    ADAPTER_STATE       = 0b0100_0000
    NO_NETWORK          = 0b1000_0000
...
## Phone Menu `0b0000_0010`

Indicates that the telephone menu is active on the on-board monitor or MID.
...
## Screen Locked `0b0000_1000`

Indicates that the telephone screen is locked.

    UNLOCKED = 0b0000_0000
    LOCKED   = 0b0000_1000
...
## Adapter State `0b0100_0000`

Older telephone systems use this bit to indicate whether the telephone adapter is installed.

    NOT_INSTALLED = 0b0000_0000
    INSTALLED     = 0b0100_0000

## No Network `0b1000_0000`

Later telephone variants use this bit when no mobile network is available.

    NETWORK_AVAILABLE = 0b0000_0000
    NO_NETWORK        = 0b1000_0000
